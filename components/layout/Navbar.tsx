          ...
          {user ? (
            <>
                ...
                { (isAdmin === true) &&
                  <Link href="/admin" 
                  className="block" 
                  onClick={() => setIsOpen(false)}>Admin Dashboard</Link>
                }
              <button
                onClick={handleLogout}
            ...
            <>
              <Link href="/login" className="block" onClick={() => setIsOpen(false)}>Login</Link>
              <Link href="/register" className="block" onClick={() => setIsOpen(false)}>Sign Up</Link>
            </>
          )}
        </div>
      )}
